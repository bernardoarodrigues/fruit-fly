...
3. **Eon's embodiment supplies a practical integration recipe.** The [expanded public-code audit](15-eon-public-code-audit.md) found an additional notebook with explicit P9 walking-context stimulation, leg-taste inputs and stored motor-neuron responses. The [integration follow-up](16-eon-integration-insights.md) prioritizes testing that protocol with the existing male graph and body. Exact physical-demo mappings remain unspecified; the original [code audit](07-reference-code-audit.md) records the narrower first pass.
