...
3. **Eon's embodiment supplies a practical integration recipe.** The [expanded public-code audit](15-eon-public-code-audit.md) found an additional notebook with explicit P9 walking-context stimulation, leg-taste inputs and stored motor-neuron responses. The [reviewed neural panel](../docs/eon-p9-context-independent-review.md) found context-dependent recruitment and persistent physiological failures. The user cancelled the body integration benchmark; the inhibitory factorial is now the primary scientific focus. Exact physical-demo mappings remain unspecified; the original [code audit](07-reference-code-audit.md) records the narrower first pass.
