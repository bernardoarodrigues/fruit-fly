...
run=replace(run,'return','tick_ref_found, tick_ref_ticks, tick_ref_cells, tick_ref_values)','tick_ref_found, tick_ref_ticks, tick_ref_cells, tick_ref_values, changed_counts, removed_sum)')
