...
OUT = ROOT / "validation/inhibitory-recurrent-panel-results-independent-review-v2.json"
...
def review(out, visual_sha):
    ...
    for field in ["H0_minus_C0", "H1_minus_C1", "C1_minus_C0", "H1_minus_H0", "interaction"]:
        text = " | ".join(("+" if r["effects_hz"][field][6] > 0 else "") + number(r["effects_hz"][field][6]) for r in factors)
    ...
    for p in ["docs/inhibitory-factorial-design-review.md", "docs/ln-inhibitory-linear-filter-results.md", "docs/inhibitory-promotion-gates.md",
              ...
              "validation/inhibitory-recurrent-panel-results-independent-review.json",
              "validation/inhibitory-recurrent-panel-results-review-amendment.json"]:
        record(ROOT / p)
