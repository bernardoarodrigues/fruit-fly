...
FIGURE = ROOT/'validation/navigation-ladder-mbon-input-figure.png'
RECEIPT = ROOT/'validation/navigation-ladder-mbon-input-plot-receipt.json'
...
def main():
    ...
    receipt = dict(schema=1,passed=False,
        ...
        rendering=dict(format='PNG',first_render=True,log_color_scale=True,isi_stairs_baseline=None,
                       visual_inspection='Pending separate human/model view after this one rendering.'))
    inputs = []; checks = 0
    try:
        ...
        right.legend(loc='lower left',bbox_to_anchor=(-.015,-.39),frameon=False,fontsize=9,ncol=1,handletextpad=.4)
