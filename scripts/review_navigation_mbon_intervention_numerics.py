...
PREFIX = ROOT/'validation/navigation-mbon-intervention-numerics'
EXPERIMENT = ROOT/'validation/navigation-mbon-intervention-plan.json'
EXPECTED_PLAN = 'dbe66e07151e24bbbaafb3d23f52f64a8aa2c74420f0ad75dc732e3dfb8710bc'
EXPECTED_RESULTS = 'e76a210217b204d711de4afbf839127356dee72264e85b1d8e4f0db716525d29'
...
def prepare():
    ...
    plan=dict(schema=1,created_utc=datetime.now(timezone.utc).isoformat(),inputs=pins,versions=versions(),python=sys.version,
        ...
        evidence='Trial result manifests pin each selected archive .npz/.json/completion marker. Validate loaded array descriptors and payload hashes. Other archive arrays are not decoded; independent spike/state/suppression audit is separate.',
