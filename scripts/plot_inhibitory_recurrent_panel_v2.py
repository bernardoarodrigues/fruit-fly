...
OUT = ROOT / "validation/inhibitory-recurrent-panel-combined-figure-v2.png"
...
def main():
    ...
    MANIFEST.write_text(json.dumps(dict(source=before,script=record(Path(__file__)),output=record(OUT),
        ...
        rendering_correction="Version 1 duplicated centered and left panel titles and overlapped two footnotes. Version 2 removes duplicates and uses one footer text block. Numerical input unchanged; original script, PNG and manifest retained."),indent=2)+"\n")
