...
from .sensors import SensoryEncoder, SensoryParameters, MotorDecoder
...
class SimulationRunner:
    def __init__(self, config: dict | None = None):
        ...
        self.graph = Connectome.load(graph_path, verify=bool(self.config.get("verify_data", False)))
        ...
        self._trace = (self.run_dir / "telemetry.jsonl").open("a", buffering=1)
    ...
    def snapshot(self) -> dict:
        ...
        warnings = ["Female-derived body is a declared morphology surrogate for the male CNS.",
                    ...
                    "Taste, vision and proprioception are not yet mapped into this neural configuration."]
        if self.assay == "motor_probe":
        ...
        return {
            ...
            "neural": {"neurons": self.brain.n_neurons, "edges": self.brain.n_edges,
                       ...
                       "backend": "Numba CPU sparse-event LIF", "graph_sha256": self.brain.graph_sha256},
