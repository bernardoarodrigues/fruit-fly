"""Optional rolling FlyBody inference task, verified against the bounded worker.
...
class RollingWalkImitation(WalkImitation):
    ...
    def __init__(self, *args, **kwargs):
        # Composer probes observable shapes during Environment construction,
        # before initialize_episode_mjcf runs. The source's dummy 65-row pose
        # buffer is valid at this initial offset.
