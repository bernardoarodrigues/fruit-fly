...
| [Kazama and Wilson (2008)](https://doi.org/10.1016/j.neuron.2008.02.030) | Primary paper and supplement retained as separate local research copies; source hashes in validation/orn-pn-physiology-sources.json. Experimental summaries constrain a prospective synaptic comparison; published figure images are not vendored. |
